		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<%--遍历热门商品--%>
					<c:forEach items="${hotPros}" var="pro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a
									href="${pageContext.request.contextPath}/product?method=findProByPid&pid=${pro.pid}">
								<img src="${pageContext.request.contextPath}/${pro.pimage}"
									 width="130"
									 height="130" style="display: inline-block;">
							</a>
							<p><a
									href="${pageContext.request.contextPath}/product?method=findProByPid&pid=${pro.pid}" style='color:#666'>${fn:substring(pro.pname, 0, 10)}...</a></p>
			...
			<div class="container-fluid">
				<div class="col-md-12">
					<h2>最新商品&nbsp;&nbsp;<img
							src="${pageContext.request.contextPath}/img/title2.jpg"/></h2>
				</div>
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="${pageContext.request.contextPath}/products/hao/big01.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					...
					<%--遍历最新商品--%>
					<c:forEach items="${newPros}" var="newP">
						<div class="col-md-2 yes-right-border" style="text-align:center;height:200px;padding:10px 0px;">
							<a
									href="${pageContext.request.contextPath}/product?method=findProByPid&pid=${newP.pid}">
								<img src="${pageContext.request.contextPath}/${newP.pimage}"
									 width="130"
									 height="130" style="display: inline-block;">
							</a>
							<p><a
									href="${pageContext.request.contextPath}/product?method=findProByPid&pid=${newP.pid}" style='color:#666'>${fn:substring(newP.pname, 0, 10)}...</a></p>
							<p><span style="font-size:16px color: #E4393C; ">&yen;${newP.shop_price}</span></p>
						</div>
					</c:forEach>
