...
font {
	...
	<script>
		function changeCheckCode(msg) {
			msg.src = "checkcode?"+new Date().getTime();
        }
	</script>
<body>
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<span id="checkMsg">${msg}</span>
		<form class="form-horizontal" style="margin-top:5px;"
			  action="${pageContext.request.contextPath}/user?method=registUser" method="post">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
					<img src="checkcode"  onclick="changeCheckCode(this)" title="点击改变验证码">
			    </div>
