		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a
							href="${pageContext.request.contextPath}/product?method=findProductByCid&cid=${product.category.cid}&thisPage=1">${product.category.cname}&nbsp;&nbsp;&gt;</a>
					<a>${product.pname}</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商场价: <strong
								style="color:#ef0101;">￥${product.market_price}
						</strong> 市 场 价： <del>￥${product.shop_price}</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form method="post"
								  action="${pageContext.request.contextPath}/cart?method=add2Cart&pid=${product.pid}">
