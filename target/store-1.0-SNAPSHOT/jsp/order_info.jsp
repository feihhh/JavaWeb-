			...
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								<th colspan="5">订单编号: ${order.orders.oid}</th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
				...
				<div style="text-align:right;margin-right:120px;">
					商品金额: <strong style="color:#ff6600;">￥${order.orders.total}元</strong>
				</div>
				...
				<div>
					...
					<form id="orderForm" class="form-horizontal"
						  method="post"
                       action="${pageContext.request.contextPath}/order?method=makeOrder&oid=${order.orders.oid}&total=${order.orders.total}"
